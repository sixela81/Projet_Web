 ...
 * @author adelacro
 */
@WebServlet(name = "CAproductServlet", urlPatterns = {"/CAproductServlet"})
public class CAproductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            result.put("records", dao.CAproduct(datedebSQL, datefinSQL));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CAproductServlet.class.getName()).log(Level.SEVERE, null, ex);
