 ...
 * @author cptbo
 */
@WebServlet(name = "CAcustomerJsonServlet", urlPatterns = {"/ChiffreAffairecustomer"})
public class CAcustomerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            result.put("records", dao.CAclient(datedebSQL, datefinSQL));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        } catch (DAOException | ParseException | SQLException ex) {
            Logger.getLogger(CAcustomerServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
