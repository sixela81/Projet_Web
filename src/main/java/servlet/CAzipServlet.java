 ...
 * @author adelacro
 */
@WebServlet(name = "CAzipServlet", urlPatterns = {"/CAzipServlet"})
public class CAzipServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            result.put("records", dao.CAzip(datedebSQL, datefinSQL));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CAzipServlet.class.getName()).log(Level.SEVERE, null, ex);
